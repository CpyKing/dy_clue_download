...
var requestBody = {"startTimeMs":1735167605000,"endTimeMs":1735179250000,
                   "roomId": "7452487756485249811","dimensions":["stat_time_minute"]}
...
fetch('https://leads.cluerich.com/bff/statistic/live-screen/clue-detail', {
  method: 'POST',
  body: JSON.stringify(requestBody),
  headers: headers
}).then(response => response.json())
.then(data => {
    // console.log('this is resule ...');
    // console.log(data);
    ...
    for(var i = 0; i < clue_list.length; i++){
        ...
        write_content = write_content + lp_screen_clue_id + ',' + tags + '\n';
    }
    // console.log('this is write', write_content);
